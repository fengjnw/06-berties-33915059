...
- Description: Search and filter books with JSON response
- Query Parameters:
...
- Error Responses: Returns HTTP 400 with JSON error details for invalid input
- Success Response: JSON array of book objects
